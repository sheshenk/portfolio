...
const IntroductionHeadings = () => {
    return (
        <VStack align='baseline' className="fade-in">
            <Text fontSize='3xl' align='left'>Hi, my name is</Text>
            <Heading fontSize='8xl' align='left' className="animated-gradient">Shashank{isMobile ? '' : ' Acharya'}.</Heading>
            <Heading fontSize='6xl' align='left' color={useColorModeValue('gray.500', 'gray.300')}></Heading>
            <Text fontSize='3xl' align='left' maxW='800px'>
